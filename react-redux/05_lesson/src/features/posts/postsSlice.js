...
//     (posts, userId) => { return posts.filter(post => post.userId === userId) } // return data
// )

export const selectPostsByUser = createSelector(
    [selectAllPosts, (state, userId) => ({ state, userId }) ],
    (posts, {state, userId}) => posts.filter(post => post.userId === userId)
)
